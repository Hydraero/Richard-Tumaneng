  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "slide-in-left": "slide-in-left 0.75s cubic-bezier(0.250, 0.460, 0.450, 0.940)   both",
        "slide-in-right": "slide-in-right 0.75s cubic-bezier(0.250, 0.460, 0.450, 0.940)   both",
